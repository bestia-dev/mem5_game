...
const GAME_RULES1: &str = "This multi-player game is prepared for \
     ...
     https://bestia.dev/mem5
      on all smartphones. \
     For better user experience choose ";

const GAME_RULES2: &str =
    "On the start page write your nickname. \
     ...
     The green color calls for and action, the red means wait and the orange is informational.\
